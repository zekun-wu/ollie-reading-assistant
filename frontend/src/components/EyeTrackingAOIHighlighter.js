/**
 * AOI Highlighter for Eye-Tracking Mode
 * Shows blinking highlight for AOI that triggered guidance
 *
...
const EyeTrackingAOIHighlighter = ({ aoiBbox, imageSize, isActive }) => {
...
export default EyeTrackingAOIHighlighter;
